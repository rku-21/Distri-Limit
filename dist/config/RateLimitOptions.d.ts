...
export type RateLimiterOptions = RateLimitOptions & (SlidingWindowCounterOptions | SlidingWindowLogOptions | TokenBucketOptions | FixedWindowOptions | LeakyBucketOptions);
